...
In this architecture, we use the direct Fourier Transform matrix $F$ instead of the non-uniform FFT approximation. We show the principle of our approach at a simplified Coordinate Descent example. Let us minimize the objective function \eqref{cd:clean}.
