...
How we approximate the Fourier Transform, whether we use the non-uniform FFT or the direct Fourier Transform, leads to different approximation opportunities. Removing highly redundant Visibilities does not significantly speed up the non-uniform FFT, since it scales linearly with the number of Visibilities. The direct Fourier Transform however benefits both in terms of runtime costs and memory requirement.
