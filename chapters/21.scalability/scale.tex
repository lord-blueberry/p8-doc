...
Major Cycle approximations are hard to distribute on many machines. It is still an open problem. This architecture without approximations has potential to be distributed. However it is too expensive as is to be viable.
