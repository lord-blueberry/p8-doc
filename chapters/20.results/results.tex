...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth, trim={0.2in, 0.2in, 0, 0.2in}, clip]{./chapters/20.results/mixed/mixed_cut_model.png}
		\caption{Ground truth.}
		\label{results:mixed:cut0}
	\end{subfigure}
	\begin{subfigure}[b]{0.6\linewidth}
		\includegraphics[width=\linewidth, trim={0.2in, 0.2in, 0, 0.2in}, clip]{./chapters/20.results/mixed/mixed_cut0.png}
		\caption{ground truth}
		\label{results:mixed:cut0}
	\end{subfigure}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth, trim={0.2in, 0.2in, 0, 0.2in}, clip]{./chapters/20.results/mixed/mixed_cut_model2.png}
		\caption{ground truth}
		\label{results:mixed:cut0}
	\end{subfigure}
	\begin{subfigure}[b]{0.6\linewidth}
