...
Let us look at the intensity profile of the first extended emissions in figure \ref{results:mixed:cut0:contour}. The Ground truth in image \ref{results:mixed:cut0:img} shows a Gaussian extended emission with an oval shape. The figure \ref{results:mixed:cut0:profile} compares the intensity profile of Coordinate Descent with CLEAN and the ground truth.
