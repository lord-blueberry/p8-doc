...
We compare the reconstruction quality to CASA's CLEAN implementation. Coordinate Descent was able to produce a super-resolved version of the simulated measurements, reconstructing point sources above the accuracy
Coordinate Descent gets compared to CASA's CLEAN implementation. 
...
Two point sources, with flux of 2.5 and 1.4. Located at a single pixel. 
...
\subsection{Reconstruction of mixed sources}
